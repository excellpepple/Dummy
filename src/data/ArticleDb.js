...
const CurrentEventsDb = () => {
    return ([
        {   "title":"Sleaze is just a symptom – democratic politics in the UK is dying",
            ...
            "summary":"As the gap between people and politics grows, government is less interested in the good of society than in rewarding loyalty. Alan Finlayson is professor of political and social theory at the University of East Anglia. Though fears of Covid-19 are spiking once again, this seems to be a comforting moment for the Labour party. After a disastrous few weeks for the ruling party, it seems as though politics is returning to 'normal': sleazy Tories are being sleazy, reneging on commitments to the 'red wall', and the opposition is sneaking ahead in the polls."
        },
        {   "title":"No plans to suspend events in China over Peng, says ITF chief-BBC",
            "author":"Reuters",
            "summary":"Tennis - WTA Mandatory - Madrid Open - Madrid, Spain - May 6, 2018. China's Peng Shuai in action against Spain's Garbine Muguruza during their round of 64 match. REUTERS/Susana VeraDec 5 (Reuters) - The president of the International Tennis Federation (ITF) told the BBC that it did not have plans to suspend events in China amid widespread concern for player Peng Shuai.The former doubles world number one made a sexual assault accusation against former Chinese Vice-Premier Zhang Gaoli then disappeared from public view last month, prompting the Women's Tennis Association (WTA) to suspend its lucrative tournaments in China."
        },        
        {   "title":"Covishield current monthly production capacity 250-275 mn doses, Covaxin 50-60 million doses: Govt",
            "author":"Ashok Chawla",
            "summary":"AgenciesFurther, as communicated by Bharat Biotech International Limited, Hyderabad, the current monthly production capacity of Covaxin is 50-60 million doses, Minister of State for Health Bharati Pravin Pawar said in a written reply.As communicated by the Serum Institute of India, the current monthly production capacity of anti-Covid vaccine Covishield is 250-275 million doses, the government informed Lok Sabha on Friday. Further, as communicated by Bharat Biotech International Limited, Hyderabad, the current monthly production capacity of Covaxin is 50-60 million doses, Minister of State for Health Bharati Pravin Pawar said in a written reply."
        },
        {   "title":"Moderna can make vaccine for Omicron by early next year",
            "author":"Sashi Sreedharan",
            "summary":"Moderna Inc. Chief Medical Officer Paul Burton said he suspects the new omicron coronavirus variant may elude current vaccines, and if so, a reformulated shot could be available early in the new year. 'We should know about the ability of the current vaccine to provide protection in the next couple of weeks,' Burton said Sunday on the BBC's 'Andrew Marr Show.' 'If we have to make a brand new vaccine, I think that's going to be early 2022 before that's really going to be available in large quantities,' he said."
        },
        {   "title":"India to log double-digit growth this fiscal: CEA K V Subramanian",
            "author":"Shantanu Nandan Sharma",
            "summary":"Chief Economic Adviser (CEA) K V Subramanian on Tuesday said India is expected to log double-digit growth in the current financial year, aided by rising demand and a robust banking sector. He also said the seminal second generation reforms would help the country grow over 7 per cent during this decade. India's GDP growth stood at 8.4 per cent in the second quarter of 2021-22, with the economy surpassing the pre-COVID level, official data showed on Tuesday. With regard to fiscal deficit, he said the Budget estimate is likely to be met."
        },
        {   "title":"Health-care workers in Quebec want COVID-19 booster shots",
            "author":"Phil Carpenter",
            "summary":"Quebec health-care workers want to know why they are not allowed to get COVID-19 booster shots. For weeks, the province has been offering third doses to certain population groups, including those with weakened immune systems and people with two doses of the Janssen (Johnson and Johnson), AstraZeneca, or Covishield vaccines.Those working on the front lines with COVID-19 patients, though, have not been included.'It's mysterious because it's clearly recognized across the world that you need at least three doses to be able to maintain the current level of vaccine efficacy against current and emerging variants,' Dr...."
        },
        {   "title":"India's fiscal deficit for April-October reaches 36.3% of full year target",
            "author":"Shantanu Nandan Sharma",
            "summary":"The government may also fall short of meeting the disinvestment target set for the current fiscal and along with cut in fuel excise will add to fiscal pressures.India's fiscal deficit reached 36.3 per cent of the full year target for the first seven months from April to October. The fiscal gap stood at rs 5.47 lakh crore. Receipts were Rs 12.79 lakh crores while total expenditure came in at Rs 18.27 lakh crore. The government had pegged this year's fiscal deficit at 6.8 per cent of GDP. The target could be missed on account of extension of free food grain scheme and settling Air India's liabilities worth Rs 44,000 crore."
        },
        {   "title":"Reliance Nippon Life aims at over 20 pc growth in new biz premium in FY22",
            "author":"Ashok Chawla",
            "summary":"Vohra said in the current fiscal till October 2021, the company has settled over 8,800 claims worth over Rs 217 crore with a claim settlement ratio of 99.12 per cent. Private life insurer Reliance Nippon Life Insurance is expecting more than 20 per cent growth in new business premium in the current financial year, a top company official said. The company is a joint venture between (51 per cent) and Nippon Life (49 per cent). In the current fiscal (year-till-date October), our new premium growth has been 20 per cent."
        },
        {   "title":"Rising sun: Renewables to dominate new power capacity through 2026 -IEA",
            "author":"Harsh V Pant",
            "summary":"APIEA warned that over the next five years, average annual additions of solar and wind capacity would need to nearly double from the agency's current predictions to achieve net zero emissions by 2050, while annual demand growth for biofuels would need to quadruple.Renewable energy should account for nearly 95% of the increase in power capacity in the world through 2026, a report by the International Energy Agency (IEA) showed on Wednesday, with solar power providing more than half the boost. The milestone comes despite rising costs for materials used to make solar panels and wind turbines."
        },
        {   "title":"Iraq expects OPEC to agree to sustain current output policy -state news agency",
            "author":"Reuters",
            "summary":"South Oil Company chief Ihsan Abdul Jabbar speaks during an interview with Reuters in Basra, Iraq May 18, 2019. REUTERS/Essam al-SudaniCAIRO, Dec 1 (Reuters) - Iraqi oil minister Ihsan Abdul Jabbar expects OPEC to agree on extending its current production policies over the short term, he told the state news agency on Wednesday.Iraq's stance will be aligned with the outcome of the next meeting of the Organization of the Petroleum Exporting Countries (OPEC), the minister said.Register now for FREE unlimited access to reuters."
        }
    ]);
}
...
const ScienceDb = () => {
    return ([
        {   "title":"China promotes global science literacy",
            "author":"ZHANG ZHIHAO",
        ...
        {   "title":"Closing the Gap in Computer Science Education",
            "author":"Katie Booth",
            "summary":"I believe teaching is one of the most important yet challenging professions. A good and supportive teacher can have an immensely positive impact on a student, helping to ignite a lifelong passion for a particular subject. I think of my own experience in high school. Two of my favorite classes were physics and chemistry. These classes relied on technical skills and computational thinking, along with experiments and hands-on activities that engaged me. I remember the thrill of seeing the pieces come together in my head and how that translated to our world."
        },
        {   "title":"Sen. Rand Paul blasts Dr. Fauci for claiming that he represents science",
            "author":"Valerie Richardson",
            "summary":"White House chief medical adviser Anthony Fauci insists that Republicans are actually criticizing science when they criticize him, but Sen. Rand Paul disagrees with the doctor's political diagnosis. The Kentucky Republican denounced Dr. Fauci for declaring 'I represent science' in a Sunday interview on CBS' 'Face the Nation.' 'The absolute hubris of someone claiming THEY represent science,' tweeted Mr. Paul, who is also a medical doctor. 'It's astounding and alarming that a public health bureaucrat would even think to claim such a thing, especially one who has worked so hard to ignore the science of natural immunity."
        },
        {   "title":"New Course from ChildCare Education Institute on Discovering Life Science with Young Children",
            "author":"Childcare Education Institute",
            "summary":"ATLANTA, GA, Dec. 02, 2021 (GLOBE NEWSWIRE) -- ChildCare Education Institute® (CCEI), an online child care training provider dedicated exclusively to the early care and education workforce, is proud to introduce CUR131: Discovering Life Science with Young Children to the online child care training course catalog. Life science refers to the study of living organisms and life processes. For young children, the study of life science revolves around exploring the natural world, exposure to basic concepts, practicing scientific thinking skills, and developing basic domain-related vocabulary."
        }
    ]);
}
const EconomyDb = () => {
    return ([
        {   "title":"Most gig economy workers have been injured at work",
            "author":"Andrew Young",
            "summary":"The average gig economy worker only has enough savings to last them five weeks off work - compared to seven weeks for employed workers, data has revealedGig economy work includes jobs like food delivery riders or lift servicesMost gig economy workers have been injured at work, suffering sprains, cuts that needed stitches - and even broken bones. A study of 1,000 gig economy workers found that, of the 59 percent who have been injured, 85 percent were unable to work for an average of five weeks. But 60 percent claim this was unpaid, with more than one in ten admitting they should have taken time off but didn't."
        },
        {   "title":"India's economy grows by 8.4% amid signs of recovery",
            "author":"Abc News",
            "summary":"India has reported that its economy grew at an 8.4% annual pace in the July-September quarter in the latest sign of an economic recovery in Asia's third-largest economyNEW DELHI -- India's economy grew at an 8.4% annual pace in the July-September quarter in the latest sign of an economic recovery in Asia's third-largest economy, the government reported Tuesday.India suffered one of the biggest setbacks of any major economy in the last fiscal year.In the same quarter a year before, the economy contracted by 7."
        },
        {   "title":"Huffman on the Sharing Economy and Competition",
            "author":"Lawrence Solum",
            "summary":"Max Huffman (Indiana University Robert H. McKinney School of Law) has posted The Sharing Economy and Competition (UNCTAD Competition and Consumer Protection Policies for Inclusive Development in the Digital Era 2021) on SSRN.  Here is the abstract: The chapter deals with the topic of the sharing economy, with an emphasis on ride sharing due to its uniquely broad worldwide absorption and the commodity nature of the services provided. It begins by examining the sharing economy in general, studying its definition, its history, its growth world-wide, and its economic rationale."
        },
        {   "title":"Coupling and Coordinating Relationship between Tourism Economy and Ecological Environment—A Case Study of Nagasaki Prefecture, Japan",
            "author":"Sunhee Suk",
        ...
        {   "title":"Possible turnaround? 7 stocks with up to 39% upside in next 12 months",
            "author":"Suraj Goel",
            "summary":"Despite their stock scores going for a toss in the last 3 months, analysts are bullish on the below mentioned seven stocks. According to analysts, these stocks can generate returns of up to 39% in the next 12 months. All stocks belong to different sectors with a majority having high net profit margin (NPM) and return on equity (ROE).ET Stock Screener provides a list of stocks which can be useful in one's decision-making process while investing."
        },
        {   "title":"Stocks To Trade In December",
            "author":"Bill Sarubbi",
            "summary":"Here are the cycles-based trade recommendations for the DJIA stocks in this month. In November, the long trades returned an average of -4.14% versus a change of -3.46% in the DJIA in comparison to a return of -3.81% for the short sales. Over the last 16 months, the long stocks have risen by an amount double that of the DJIA. The short sale recommendations have fallen slightly.   For the month of December, the cycle/relative strength concept is applied."
        }
    ]);
}
const GetArticles = () => {
